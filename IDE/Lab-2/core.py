...
#Instance Vars
  ...
  def initUI(self):
    ...
    self.connect(self.ui.plmin, QtCore.SIGNAL('clicked()'), self.opClicked)
    self.connect(self.ui.pow, QtCore.SIGNAL('clicked()'), self.opClicked)
    self.connect(self.ui.sqrt, QtCore.SIGNAL('clicked()'), self.opClicked)
  ...
  def enterClicked(self):
    ...
    if self.operation == 'pow':
      self.ans = math.pow(self.previousNum, self.currentNum)
